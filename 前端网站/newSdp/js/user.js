...
//只看自己的选中状态
$(function() {
	$('.onlyself a').each(function(i) {
		$(this).click(function() {
			$('.onlyself a').toggleClass('active');
...
//我要留言图片的显示与隐藏
//			$('.littlimg').toggleClass('adcolor');
			//$(".imggbig").toggle();
//$(function() {
//	$('.littlimg').each(function(i) {
//		$(this).click(function() {				
//
//			if($(this).parent().children(".imggbig").css("display")=="none")
//			{
//				$(this).parent().children(".littlimg").addClass('adcolor');
//				$(this).parent().children(".imggbig").show();
//			}
//			else{
//				$(this).parent().children(".littlimg").removeClass('adcolor');
//				$(this).parent().children(".imggbig").hide();
//			}
//		})
//	})
//
...
//我要留言图片的显示与隐藏
function showPictures(name,count,index,object)
{
		var tmpId = name + "_"+index;
		if($(object).parent().children("div[id='"+tmpId+"']").css("display")=="none"){
			$(object).parent().children("div[id='"+tmpId+"']").show();
		}
		else{
			$(object).parent().children("div[id='"+tmpId+"']").hide();
		}
		
		if($(object).attr("class").indexOf("adcolor")>0){
			$(object).removeClass("adcolor");
		}
		else{
			$(object).addClass("adcolor");
			$(object).siblings().removeClass("adcolor");
		}
