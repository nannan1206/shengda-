(function(root, factory) {
	...
	Paging.prototype = {
		...
		format: function() {
			var html = '<ul>'
			html += '<a href="javaScript:void(0);"><li class="js-page-first js-page-action ui-pager" >' + this.settings.firstTpl + '</li></a>';
			html += '<a href="javaScript:void(0);"><li class="js-page-prev js-page-action ui-pager">' + this.settings.prevTpl + '</li></a>';
			if (this.pagecount > 6) {
				html += '<a href="javaScript:void(0);"><li data-page="1" class="ui-pager">1</li></a>';
				if (this.current <= 2) {
					html += '<a href="javaScript:void(0);"><li data-page="2" class="ui-pager">2</li></a>';
					html += '<a href="javaScript:void(0);"><li data-page="3" class="ui-pager">3</li></a>';
					html += '<a href="javaScript:void(0);"><li class="ui-paging-ellipse">' + this.settings.ellipseTpl + '</li></a>';
				} else
				if (this.current > 2 && this.current <= this.pagecount - 2) {
					html += '<a href="javaScript:void(0);"><li>' + this.settings.ellipseTpl + '</li></a>';
					html += '<a href="javaScript:void(0);"><li data-page="' + (this.current - 1) + '" class="ui-pager">' + (this.current - 1) + '</li></a>';
					html += '<a href="javaScript:void(0);"><li data-page="' + this.current + '" class="ui-pager">' + this.current + '</li></a>';
					html += '<a href="javaScript:void(0);"><li data-page="' + (this.current + 1) + '" class="ui-pager">' + (this.current + 1) + '</li></a>';
					html += '<a href="javaScript:void(0);"><li class="ui-paging-ellipse" class="ui-pager">' + this.settings.ellipseTpl + '</li></a>';
				} else {
					html += '<a href="javaScript:void(0);"><li class="ui-paging-ellipse" >' + this.settings.ellipseTpl + '</li></a>';
					for (var i = this.pagecount - 2; i < this.pagecount; i++) {
						html += '<a href="javaScript:void(0);"><li data-page="' + i + '" class="ui-pager">' + i + '</li></a>'
					}
				}
				html += '<a href="javaScript:void(0);"><li data-page="' + this.pagecount + '" class="ui-pager">' + this.pagecount + '</li></a>';
			} else {
				for (var i = 1; i <= this.pagecount; i++) {
					html += '<a href="javaScript:void(0);"><li data-page="' + i + '" class="ui-pager">' + i + '</li></a>'
				}
			}
			html += '<a href="javaScript:void(0);"><li class="js-page-next js-page-action ui-pager">' + this.settings.nextTpl + '</li></a>';
			html += '<a href="javaScript:void(0);"><li class="js-page-last js-page-action ui-pager">' + this.settings.lastTpl + '</li></a>';
			html += '</ul>';
